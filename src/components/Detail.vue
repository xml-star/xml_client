            ...
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart"><img @click="add_cart" alt="">加入购物车</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="(chapter) in chapter_list">
                            ...
                            <ul class="lesson-list">
                                <li v-for="(coursesection,index) in chapter.coursesections" :key="index" class="lesson-item">
                                    <p class="name"><span class="index">{{chapter.chapter}}-{{ index+1 }}</span>
                                        {{ coursesection.name }}<span class="free">免费</span>
                                    </p>
