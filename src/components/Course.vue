            ...
            <div class="course-list">
                <div class="course-item" v-for="course in course_list">
                    <div class="course-image">
                        <img :src="course.course_img" alt="" width="423px" height="210px">
                    </div>
                    <div class="course-info">
                        <h3 href=""><router-link :to="'/detail/'+course.id">{{ course.name }}</router-link><span><img src="/static/image/avatar1.svg"
                        ...
                        <ul class="lesson-list">
                            <li v-for="(lesson, key) in course.lesson_list"><span class="lesson-title">{{ key + 1 }} | 第{{
                                    key + 1
                                }}节：{{ lesson.name }}</span>
