<template>
    <div class="cart">
        ...
        <div class="cart-info">
            ...
            <div v-for="course in course_list" class="cart-item">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price">{{ course.final_price }}</el-col>
                    <el-col :span="4" class="course-price">原价：{{ course.price }}</el-col>
                </el-row>
            </div>
            ...
            <div class="calc">
                <el-row class="pay-row">
                    ...
                    <el-col :span="8">
                        <span class="alipay">
                            <img src="../../static/image/alipay.png" alt="" v-if="isShow" @click="choose_paytype">
                            <img src="../../static/image/alipay2.png" alt="" v-else>
                        </span>
<!--                        <span class="alipay wechat"><img src="../../static/image/hmbaobao.jpg" alt=""></span>-->
                    </el-col>
                    <el-col :span="8" class="count">实付款： <span>{{ total_price }}</span></el-col>
                    <el-col :span="4" class="cart-pay"><span @click="go_pay">支付宝支付</span></el-col>
                </el-row>
            </div>
        </div>
        <Footer/>
