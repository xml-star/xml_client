        ...
        <div class="cart_info">
            ...
            <div class="cart_table">
                ...
                <div class="cart_course_list">
                    <CartItem v-for="(course,index) in cart_list" :index=index :course="course" @delete_course="del_course(index)" @change_select="get_total_price" @change_expire="get_total_price">
<!--                        <span v-show="false" class="pricex">{{ course.price }}</span>-->
                    </CartItem>
